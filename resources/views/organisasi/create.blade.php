	...
	<div class="container">
		<div class="col-md-12">
			<div class="panel panel-primary">
			  <div class="panel-heading">Tambah Data Organisasi
			  	<div class="panel-title pull-right"><a href="{{ route('organisasis.index') }}">Kembali</a>
			  	</div>
			  </div>
			  <div class="panel-body">
			  	<form action="{{ route('organisasis.store') }}" method="post" >
			  		{{ csrf_field() }}
			  		...
			  		<div class="form-group {{ $errors->has('tempat_latihan') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="tempat_latihan" class="form-control"  required>
			  		...
			  		<div class="form-group {{ $errors->has('waktu_latihan') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="waktu_latihan" class="form-control"  required>
			  		...
			  		<div class="form-group {{ $errors->has('hari_latihan') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="hari_latihan" class="form-control"  required>
